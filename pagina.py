...
if pagina_seleccionada == "Presentación":
    ...
    with col5:
        ...
        st.markdown("<div style='width:200px; margin:auto; text-align:center; font-size:24px; color:#dc2f82; font-weight:bold;'>André Mere Rivera</div>",unsafe_allow_html=True)
