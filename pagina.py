...
if pagina_seleccionada == "Presentación":
    ...
    with col8:
        ...
        st.markdown("<div style='width:200px; margin:auto; text-align:left; font-size:18px; color:#3c8d6b; font-weight:bold;'>Coordinación de Difusión y Prensa</div>",unsafe_allow_html=True)
