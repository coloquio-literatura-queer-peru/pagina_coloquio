...
if pagina_seleccionada == "Presentación":
    ...
    st.markdown("""
        <h1 style="
            ...
            margin-bottom:20px;
        ">
        Feria del Libro y Publicaciones LGBTIQ+
        </h1>
    """, unsafe_allow_html=True)
    ...
    with col41:
        st.image("fotos/cronica_diversidad.png")
        with st.container(border=True):
            st.markdown("""
            <h3 style="
                text-align:center;
    ...
    with col42:
        st.image("fotos/almas_feministas.png")
        with st.container(border=True):
            st.markdown("""
            <h3 style="
                text-align:center;
    ...
    ">
        ...
        <p style="color:#444;">
            Expresamos nuestro más sincero agradecimiento a <b>AHF Perú</b>,
            <b>REDLIT</b> y, de manera especial, a <b>Rebeca Chávez</b>,
            por su valioso apoyo en la cobertura fotográfica del
            <i>I Coloquio de Literatura Peruana Queer</i>.
        </p>
    </div>
    """, unsafe_allow_html=True)
    ...
    with col86:
        st.image("fotos/sabado20_3.jpg")
    with col87:
        st.image("fotos/sabado20_1.jpg")
    ...
    col97, col98, col99 = st.columns(3)
    with col97:
    ...
    col1, col2, col3 = st.columns(3)
    with col1:
        st.image("fotos/sabado20_27.jpg")
    with col2:
        st.image("fotos/sabado20_28.jpg")
    with col3:
        st.image("fotos/sabado20_29.jpg")

    col1, col2, col3 = st.columns(3)
    with col1:
        st.image("fotos/sabado20_30.jpg")
    with col2:
        st.image("fotos/sabado20_32.jpg")
    with col3:
        st.image("fotos/sabado20_31.jpg")

    col1, col2, col3 = st.columns(3)
    with col1:
        st.image("fotos/sabado20_10.jpg")
    with col2:
        st.image("fotos/sabado20_9.jpg")
    with col3:
        st.image("fotos/sabado20_8.jpg")

    col1, col2, col3 = st.columns(3)
    with col1:
        st.image("fotos/sabado20_33.jpg")
    with col2:
        st.image("fotos/sabado20_7.jpg")
    with col3:
        st.image("fotos/sabado20_6.jpg")
    ...
    col1, col2, col3 = st.columns(3)
    with col1:
        img1 = Image.open("fotos/domingo21_1.jpg").rotate(270, expand=True)
        st.image(img1)
    with col2:
        img2 = Image.open("fotos/domingo21_2.jpg").rotate(270, expand=True)
        st.image(img2)
    with col3:
    ...
    col1, col2, col3 = st.columns(3)
    with col1:
        st.image("fotos/domingo21_22.JPG")
    with col2:
        st.image("fotos/domingo21_23.JPG")
    with col3:
        st.image("fotos/domingo21_24.JPG")

    col1, col2, col3 = st.columns(3)
    with col1:
        st.image("fotos/domingo21_26.JPG")
    with col2:
    ...
    col1, col2, col3 = st.columns(3)
    with col1:
        st.image("fotos/domingo21_32.JPG")
    with col2:
        st.image("fotos/domingo21_33.JPG")
    with col3:
        st.image("fotos/domingo21_34.JPG")

    col1, col2, col3 = st.columns(3)
    with col1:
        st.image("fotos/domingo21_31.JPG")
    with col2:
        st.image("fotos/domingo21_35.JPG")
    with col3:
        st.image("fotos/domingo21_36.JPG")
