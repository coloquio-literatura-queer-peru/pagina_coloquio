...
if pagina_seleccionada == "Presentación":
    ...
    with col5:
        ...
        st.markdown("<div style='width:490px; margin:auto; text-align:left; font-size:17px; color:#3c8d6b; font-weight:bold;'>Coordinación de Comunicaciones y Experiencias del Público</div>",unsafe_allow_html=True)
