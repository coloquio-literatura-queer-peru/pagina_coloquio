...
if pagina_seleccionada == "Presentación":
    ...
    **Lo queer en los Andes: entre la representación y el silencio en las ruralidades peruanas**  
    por **Fátima Denisse Córdova Luna**
    """)
    
    # Mesa 1
    st.markdown("---")
    st.markdown("## 📖 Mesa de Ponencias #1")
    ...
    **4:10 PM - 5:20 PM**
    ...
    ponencias_1 = [
        '"El egoísmo del cuerpo: poéticas del repliegue y disidencia en Matrioska de Valeria Román Marroquín" — Jimena Sofía Velarde Vera',
        
        '"Estética queer y política del cuerpo en la narrativa de Doris Moromisato" — Judith Mavila Paredes Morales',
        
        '"«Compórtense como señoritas»: formación de la subjetividad lésbica entre violencia y deseo" — Karol Nicol Sialas Rosas'
    ]
    
    for ponencia in ponencias_1:
        st.markdown(f"- {ponencia}")
    
    # Mesa 2
    st.markdown("---")
    st.markdown("## 📚 Mesa de Ponencias #2")
    ...
    **5:40 PM - 6:50 PM**
    ...
    ponencias_2 = [
        '"El escándalo como motivo estructurante. Una relectura necesariamente ¿queer? de Vargas Llosa" — Fabio Venero Figueroa',
        
        '"La representación de la bisexualidad en Duque (1934) de José Diez Canseco" — Natalia Regina Ángeles Enciso',
        
        '"El deseo de la abyección: una lectura de la prostitución masculina desde la perrería del amor en «El triunfo» (2006) de Oswaldo Reynoso" — Giancarlos Nathanael Peralta Luis'
    ]
    
    for ponencia in ponencias_2:
        st.markdown(f"- {ponencia}")
    
    # Conversatorio
    st.markdown("---")
    st.markdown("## 🗣️ Conversatorio 1")
    
    st.info("""
    **6:55 PM - 7:05 PM**
    
    ### Memorias queer en el Perú: historias no contadas
    """)
    ...
    # Cierre audiovisual
    st.markdown("---")
    st.markdown("## 🎬 Muestra Audiovisual de Investigación #1")
