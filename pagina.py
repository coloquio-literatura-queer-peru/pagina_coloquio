...
if pagina_seleccionada == "Presentación":
    ...
    with col5:
        ...
        st.markdown("<div style='width:340px; margin:auto; text-align:left; font-size:18px; color:#3c8d6b; font-weight:bold;'>Coordinación de Comunicaciones y</div>",unsafe_allow_html=True)
        st.markdown("<div style='width:340px; margin:auto; text-align:left; font-size:18px; color:#3c8d6b; font-weight:bold;'>Experiencias del Público</div>",unsafe_allow_html=True)
