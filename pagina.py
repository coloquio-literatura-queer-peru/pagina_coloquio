...
if pagina_seleccionada == "Presentación":
    ...
    with col5:
        ...
        st.markdown("<div style='width:360px; margin:auto; text-align:left; font-size:18px; color:#3c8d6b; font-weight:bold;'>Coordinación de Comunicaciones</div>",unsafe_allow_html=True)
        st.markdown("<div style='width:360px; margin:auto; text-align:left; font-size:18px; color:#3c8d6b; font-weight:bold;'>y Experiencias del Público</div>",unsafe_allow_html=True)
