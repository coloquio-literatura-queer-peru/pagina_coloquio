...
if pagina_seleccionada == "Presentación":
    ...
    <li>La sumilla debe tener hasta 350 palabras y debe consignar la información principal de la investigación (el objeto de estudio, el tema, la hipótesis, el objetivo, el método y, de ser posible, las conclusiones). Además, cada persona podrá presentar una sola sumilla.</li>
