...
if pagina_seleccionada == "Presentación":
    ...
    with col5:
        ...
        st.markdown("<div style='width:410px; margin:auto; text-align:left; font-size:18px; color:#3c8d6b; font-weight:bold;'>Coordinación de Comunicaciones</div>",unsafe_allow_html=True)
    ...
    with col6:
        ...
        st.markdown("<div style='width:300px; margin:auto; text-align:left; font-size:18px; color:#3c8d6b; font-weight:bold;'> y Logística</div>",unsafe_allow_html=True)
