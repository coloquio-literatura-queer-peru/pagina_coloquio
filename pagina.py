...
if pagina_seleccionada == "Presentación":
    ...
    with col4:
        ...
        st.markdown("<div style='width:260px; margin:auto; text-align:left; font-size:18px; color:#3c8d6b; font-weight:bold;'>Coordinación General</div>",unsafe_allow_html=True)
        st.markdown("<div style='width:260px; margin:auto; text-align:left; font-size:18px; color:#3c8d6b;'>castillo.julia@pucp.edu.pe</div>",unsafe_allow_html=True)
